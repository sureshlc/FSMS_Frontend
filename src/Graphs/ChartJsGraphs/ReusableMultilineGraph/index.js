    ...
    function triggerTooltip() {
        ...
        if (tooltip.getActiveElements().length > 0) {
            ...
            for (let i = 0; i < graphState?.datasets?.length; i++) {
                const isValid =
                    !graphState?.datasets[i]?.data?.includes(undefined);
                if (isValid) {
            ...
            x: {
                grid: {
                    color: function (context) {
                        return context.index === activeIndex
                            ? "#414141"
                            : "#CECECE";
                    },
                    lineWidth: 1,
                ...
                ticks: {
                    ...
                    font: {
                        size: 8,
                        weight: (context) => {
                            return context.tick.value === highlightIndex
                                ? "800"
                                : "400";
                        },
                        lineHeight: "normal",
