...
import ReusableContentWithTabs from "../../components/ContentBox/ReusableContentWithTabs";
  ...
  if (type === "contentWithTabs") {
    return (
      <ContentBox
        ...
        subLabel={
          userQueries[0]?.data?.is3YearAverage
            ? "3 Year Average"
            : "" || subLabel
        }
...
const Others = () => {
  ...
  const layoutWidgets = Object.entries(l2View).map(([key, value]) => ({
    ...
    widget: <Widget pos={key} data={value} category={"sustainability"} />,
    additionalClass: "box",
  }));
