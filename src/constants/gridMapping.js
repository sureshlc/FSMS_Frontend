  ...
  two: [
    {
      ...
      info: "The color coding in the bar graphs are based on thresold values. Threshold values are set based on one standard deviation from mean.", //2024_10_02
  ...
  three: [
    {
      ...
      items: {
        one: {
          title: "Production and trade", //2024_10_02
          fill: "#FF2121",
          enableIcon: true,
          iconColor: "#FF2121",
          info: "The gross production value predictions are based on VAR(Vector Auto Regressive) model. A vector autoregressive (VAR) model is a statistical model that analyzes the relationship between multiple variables over time. It is widely recognized and used in time series forecasting.", //2024_10_02
        ...
        two: {
          title: "Consumption", //2024_10_02
          fill: "#F4C21C",
          enableIcon: true,
          iconColor: "#F4C208",
          info: "The consumption per capita predictions are based on VAR(Vector Auto Regressive) model. A vector autoregressive (VAR) model is a statistical model that analyzes the relationship between multiple variables over time. It is widely recognized and used in time series forecasting.", //2024_10_02
          data: [
            {
              value: "consumption",
              graphType: "BarGraph",
              noDataImage: Bardata,
              component: DynamicBarGraph,
              colors: ["#54A0FF"], //2024_10_02
            },
          ],
        },
        three: {
          title: "Food prices",
          fill: "#FF2121", //2024_10_02
          enableIcon: true,
          iconColor: "#FF2121", //2024_10_02
...
export const OverviewInfoAlertMapping = {
  ...
  info: {
    //2024_10_02
    0: "The gross production value predictions are based on VAR(Vector Auto Regressive) model. A vector autoregressive (VAR) model is a statistical model that analyzes the relationship between multiple variables over time. It is widely recognized and used in time series forecasting.",
    1: "The consumption per capita predictions are based on VAR(Vector Auto Regressive) model. A vector autoregressive (VAR) model is a statistical model that analyzes the relationship between multiple variables over time. It is widely recognized and used in time series forecasting.",
...
export const FoodSecurityMapping = {
  ...
  two: [
    ...
    } /*, //2024_10_02
    {
      ...
      // color: "#87C6D8",
      info: "Thresholds are based on data either above or below one standard deviation",
    }modified to remove food production variability*/,
  ],
  three: [
    {
      id: 5,
  ...
  three: [
    {
      ...
      items: {
        one: {
          ...
          //secondaryTitle: "%",
          secondaryTitle: "Tonnes/Person/Year",
          ...
          data: [
            {
              ...
              // tabTitle: "Adequacy",//2024_10_02
              unit: "t/person/year",
              //value: "average dietary energy supply adequacy",
              value: "consumption per capita",
              component: DynamicLine,
        ...
        two: {
          ...
          secondaryTitle: "1000 tonnes", //2024_10_02
          fill: "#F4C21C",
          enableIcon: true,
          iconColor: "#F4C208",
  ...
  two: [
    {
      id: 1,
      label:
        "Gross fixed capital formation on agriculture, forestry, and fishing", //2024_10_02
      enableIcon: true,
